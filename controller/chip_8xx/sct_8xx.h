...
/* Change made by KdP, 18th of Apr, 2016
 *   Table 222. Register overview, page 262 in UM10800.
 *   SCT_EVENT_6 = 6,        // !< Added by KdP, SCT EVENT register 6
 *   SCT_EVENT_7 = 7,        // !< Added by KdP, SCT EVENT register 7
*/
