/* This file is changed for the opportunity of forced fast-access to FLASH
 * (1 clocks) by use of _FORCED_FLASH_SPEED. 
 * Modified by Kent DEL PINO;   Date: 22 Oct. 2015
 */
...
#ifdef _FORCED_FLASH_SPEED
	Chip_FMC_SetFLASHAccess(FLASHTIM_20MHZ_CPU);								/* set FLASH fast-access, 1 clocks */
#else
